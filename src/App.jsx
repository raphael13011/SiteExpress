          ...
          <div style={{ display: "grid", gridTemplateColumns: m ? "1fr" : "repeat(4, 1fr)", gap: 16 }}>
            {PLANS.map((plan, i) => (
              <div key={i} className="plan-fx" style={{ background: plan.highlight ? "#0f172a" : "#fff", border: plan.orange ? "2px solid #f97316" : plan.highlight ? "2px solid #3b82f6" : "1px solid #e2e8f0", borderRadius: 20, padding: 32, position: "relative", display: "flex", flexDirection: "column" }}>
                ...
                {plan.orange && <div style={{ position: "absolute", top: -24, right: -8, width: 68, height: 68 }}><svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M50 2L58 17L75 6L72 25L91 25L80 40L97 50L80 60L91 75L72 75L75 94L58 83L50 98L42 83L25 94L28 75L9 75L20 60L3 50L20 40L9 25L28 25L25 6L42 17Z" fill="#dc2626"/><text x="50" y="44" textAnchor="middle" fill="#fff" fontSize="15" fontWeight="900" fontFamily="Inter,Arial">NEW</text><text x="50" y="62" textAnchor="middle" fill="#fff" fontSize="13" fontWeight="800" fontFamily="Inter,Arial">OFFER</text></svg></div>}
